...
local _M =
{
	...
	postgres = {
		...
		database = os.getenv('POSTGRES_DB') or 'markbot',
	},
	redis =
	{
	...
	-- Aesthetic
	lang = os.getenv('DEFAULT_LANG') or 'ar_SA',
	commit = os.getenv("GB_COMMIT"),
	channel = os.getenv("GB_CHANNEL") or '@mark4tg',
	source_code = os.getenv("GB_SOURCE") or 'https://github.com/iimarks/GroupButlerBot',
	help_group = os.getenv('HELP_GROUP') or 't.me/mark4tg',
